...
class Chess:
    ...
    def _main_menu(self):
        ...
        while True:
            ...
            for button in [
                self.menu.local_button, self.menu.bot_button, self.menu.settings_button
            ]:
    ...
    def _settings_mode(self):
         ...
         while True:
            ...
            for button in [
                self.settings_screen.back_button, self.settings_screen.pieces_button
            ]:
    ...
    def _bot_mode(self): 
        ...
        while True:
            ...
            self.play_screen.back_button.change_color(mouse_pos, self.play_screen.screen)

...
class Chess_board: 
    def __init__(self) -> None:
        self.pawn_image_white = pygame.image.load('media/elements/pieces/white/pawn.png')
        self.rook_image_white = pygame.image.load('media/elements/pieces/white/rook.png')
        self.knight_image_white = pygame.image.load('media/elements/pieces/white/knight.png')
        self.bishop_image_white = pygame.image.load('media/elements/pieces/white/bishop.png')
        self.queen_image_white = pygame.image.load('media/elements/pieces/white/queen.png')
        self.king_image_white = pygame.image.load('media/elements/pieces/white/king.png')
        self.pawn_image_black = pygame.image.load('media/elements/pieces/black/pawn.png')
        self.rook_image_black = pygame.image.load('media/elements/pieces/black/rook.png')
        self.knight_image_black = pygame.image.load('media/elements/pieces/black/knight.png')
        self.bishop_image_black = pygame.image.load('media/elements/pieces/black/bishop.png')
        self.queen_image_black = pygame.image.load('media/elements/pieces/black/queen.png')
        ...
        for row in range(0,8): 
            for col in range (0,8):
                if self.board[row][col] == 'Black Pawn': 
                    screen.blit(self.pawn_image_black, (col*87.5 + 210, row*84.5 +54))
                elif self.board[row][col] == 'White Pawn': 
                    screen.blit(self.pawn_image_white, (col*87.5 + 210, row*84.5 +54))
                elif self.board[row][col] == 'Black Rook': 
                    screen.blit(self.rook_image_black, (col*87.5 + 210, row*84.5 +54))
                elif self.board[row][col] == 'White Rook': 
                    screen.blit(self.rook_image_white, (col*87.5 + 210, row*84.5 +54))
                elif self.board[row][col] == 'Black Knight': 
                    screen.blit(self.knight_image_black, (col*88  + 200, row*84.5 +54))
                elif self.board[row][col] == 'White Knight': 
                    screen.blit(self.knight_image_white, (col*88  + 200, row*84.5 +54))
                elif self.board[row][col] == 'Black Bishop': 
                    screen.blit(self.bishop_image_black, (col*86.8  + 201.3, row*84 +52))
                elif self.board[row][col] == 'White Bishop': 
                    screen.blit(self.bishop_image_white, (col*86.8  + 201.3, row*84 +52))
                elif self.board[row][col] == 'Black Queen': 
                    screen.blit(self.queen_image_black, (col*86.5  + 200, row*84.2 +52))
                elif self.board[row][col] == 'White Queen': 
                    screen.blit(self.queen_image_white, (col*86.5  + 200, row*84.2 +52))
                elif self.board[row][col] == 'Black King': 
                    screen.blit(self.king_image_black, (col*88  + 200, row*84.2 +52))
                elif self.board[row][col] == 'White King': 
                    screen.blit(self.king_image_white, (col*88  + 200, row*84.2 +52))
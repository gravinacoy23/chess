class Button:
    def __init__(
        ...
        Args:
            ...
            text_input (string): This is waht we want to display on the screen
            font (Font): Font type defined in the pygame library, serves to load whichever font I want to use, same for all the project in this case (with different sizes).
            ...
            image (Surface, optional): This is a type defined on the pygame Library. This parameter is in the case that we want to make an image a button. So far I haven't
            use this button, might be removed in the future among with the logic use for this. Defaults to None.
        """
        self.image = image
